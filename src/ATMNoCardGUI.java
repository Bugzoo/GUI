...
import com.bugzoo.FinancialMod.PacketHandler;
import com.bugzoo.FinancialMod.SimplePacket;
...
public class ATMNoCardGUI extends GuiScreen{
	...
	public void drawScreen(int i, int j, float f){
        ...
        this.drawCenteredString(fontRendererObj, "Please Insert Your Debit Card", width/2, height / 2 - 90, 0xFFCC00);
